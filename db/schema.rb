...
ActiveRecord::Schema[7.0].define(version: 2022_11_28_163010) do
  ...
  create_table "arks", force: :cascade do |t|
    ...
    t.index ["material_id"], name: "index_arks_on_material_id"
    t.index ["style_id"], name: "index_arks_on_style_id"
  end
  ...
  add_foreign_key "arks", "materials"
  add_foreign_key "arks", "styles"
